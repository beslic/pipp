	...
	<form class="form-horizontal" method="post">
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<div
					class="col-md-4 <c:if test="${greska.nazivAnketa != null}">has-error has-feedback</c:if>">
			...
			<div class="form-group">
				<label id="passwordlabel" class="col-md-4 control-label"
					for="passwordinput">Opis ankete</label>
				<div class="col-md-4">
					<textarea id="comment" name="opisAnketa"
			...
			<div class="form-group">
				<div class="col-md-offset-4 col-md-4">
					<button type="button" onclick="dodajPitanje()">Dodaj
						pitanje</button>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div
					class="col-md-4 <c:if test="${greska.privatna != null}">has-error has-feedback</c:if>">
					<input id="privatnainput" name="privatna" class="input-md"
						type="checkbox" value="privatna"
						<c:if test="${forma.privatna eq '1'}">checked</c:if>> <span
						id="pomoc" class="help-block">Označite ukoliko ne želite da
						vaša anketa bude javno dostupna na Intenretu</span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div
					class="col-md-4 <c:if test="${greska.aktivnaOd != null}">has-error has-feedback</c:if>">
			...
			<div class="form-group">
				...
				<div
					class="col-md-4 <c:if test="${greska.aktivnaDo != null}">has-error has-feedback</c:if>">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<button id="register" type="submit" name="register"
						...
						class="btn btn-success">Stvori anketu</button>
